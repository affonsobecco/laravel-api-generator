...
use Becco\Generator\File\FileHelper;
use Becco\Generator\TemplatesHelper;
...
class PublisherCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'becco.generator:publish';
    ...
    public function publishAPIRoutes()
    {
        ...
        $apiRoutesPath = Config::get('generator.path_api_routes', app_path('routes/api.php'));
    ...
    {
        $path = Config::get('generator.path_routes', app_path('routes/web.php'));
